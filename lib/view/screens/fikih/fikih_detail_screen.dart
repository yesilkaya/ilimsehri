...
class FikihDetailScreen extends ConsumerStatefulWidget {
  final int duaID;

  const FikihDetailScreen({super.key, required this.duaID});

  @override
  DuaDetailScreenState createState() => DuaDetailScreenState();
}

class DuaDetailScreenState extends ConsumerState<FikihDetailScreen> {
